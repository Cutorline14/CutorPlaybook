...
- Path: `\CutorModules\Tools\multichoice.exe`
...
- Path: `\CutorModules\Tools\SetTimerResolution.exe`
    ...
    - Version: v1.0.0
- Path: `\CutorDesktop\3. General Configuration\Timer Resolution\! MeasureSleep.exe`
...
> [!NOTE]  
> This is included in the Playbook and isn't in the CutorModules.
